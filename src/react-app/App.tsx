		...
		<div className="auth-shell">
			<div className="auth-card">
				...
				<p className="auth-copy">
					Use a magic link, GitHub, or an enrolled passkey. Passwords are not
					supported.
				</p>
...
function MessagesApp({ appSession }: { appSession: AppSession }) {
	...
	const [authAction, setAuthAction] = useState<"logout" | "passkey" | null>(
		null,
	);
	...
	const user =
		users.find((user) => user.id === z.userID)?.name ?? appSession.user.name;
